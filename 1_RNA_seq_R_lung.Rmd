...
#PCA Plot
```{r}
tiff(file = 'Figures/PCA/Female_Lung_PCA.tiff', units="in", width=8, height=5, res=1000)
...
```{r}
tiff(file = "Figures/female_Lung_heatmap.tiff", units="in", width=8, height=5, res=1000)
...
#***volcano plots***
```{r}
tiff(file = 'Figures/volcano/Female_Exposed_volcano_plot_Lung.tiff', units="in", width=8, height=5, res=1000)
...
write_tsv(exp_resOrdered, file="Results_spreadsheets/exp_female_lung_results.tsv")
write_csv(exp_resOrdered, file="Results_spreadsheets/exp_female_lung_results.csv")
write_csv(as.data.frame(assay(F_se)), file= "Results_spreadsheets/female_lung_counts.csv")
```


```{r}
tiff(file = 'Figures/volcano/Female_pair_fed_volcano_plot_lung.tiff', units="in", width=8, height=5, res=1000)
...
write_tsv(pf_resOrdered, file="Results_spreadsheets/Female_pf_lung_results.tsv")
write_csv(pf_resOrdered, file="Results_spreadsheets/Female_pf_lung_results.csv")
```
...
write.csv(data ,file="Figures/Enrichment/Grouped_female_lung_Gene_enrichment.csv")
```


```{r}
tiff(file = 'Figures/Enrichment/Female_lung_grouped_gene_enrichment.tiff', units="in", width=8, height=5, res=1000)
...
data<-data.frame(groups)
write.csv(data ,file="Figures/Enrichment/Female_Grouped_lung_KEGG_enrichment.csv")
```


```{r}
tiff(file = 'Figures/Enrichment/Female_lung_grouped_kegg_enrichment.tiff', units="in", width=8, height=5, res=1000)
...
data<-data.frame(groups)
write.csv(data ,file="Figures/Enrichment/Grouped_Female_lung_Disease_enrichment.csv")
```


```{r}
tiff(file = 'Figures/Enrichment/Female_lung_grouped_disease_enrichment.tiff', units="in", width=8, height=5, res=1000)
...
tiff(file = 'Figures/Female_Lung_dot_plots_big.tiff', units="in",width=10, height=15, res=500)
...
#***volcano plots***
```{r}
tiff(file = 'Figures/volcano/Female_Exposed_vs_PF_volcano_plot_lung.tiff', units="in", width=8, height=5, res=1000)
...
write_tsv(F_resOrdered, file="Results_spreadsheets/exp_vs_pf_female_lung_results.tsv")
write_csv(F_resOrdered, file="Results_spreadsheets/exp_vs_pf_female_lung_results.csv")
```
...
data<-data.frame(groups)
write.csv(data ,file="Figures/Enrichment/Grouped_exp_vs_PF_Lung_Gene_enrichment.csv")
```


```{r}
tiff(file = 'Figures/Enrichment/Exp_vs_PF_Lung_grouped_gene_enrichment.tiff', units="in", width=8, height=5, res=1000)
dot34<-dotplot(groups,showCategory=3, split=".sign") +
  geom_point(shape = 1,colour = "black") +
  scale_color_viridis(option = "inferno", direction = -1) +
  facet_grid(.~.sign)+
...
data<-data.frame(groups)
write.csv(data ,file="Figures/Enrichment/Exp_vs_PF_Grouped_lung_KEGG_enrichment.csv")
```


```{r}
tiff(file = 'Figures/Enrichment/Exp_vs_PF_Lung_grouped_kegg_enrichment.tiff', units="in", width=8, height=5, res=1000)
dot28<-dotplot(groups,showCategory=3, split=".sign") +
  geom_point(shape = 1,colour = "black") +
  scale_color_viridis(option = "inferno", direction = -1) +
  facet_grid(.~.sign)+
...
data<-data.frame(groups)
write.csv(data ,file="Figures/Enrichment/Grouped_exp_vs_pf_Lung_Disease_enrichment.csv")
```


```{r}
tiff(file = 'Figures/Enrichment/Exp_vs_PF_Lung_grouped_disease_enrichment.tiff', units="in", width=8, height=5, res=1000)
dot32<-dotplot(groups,showCategory=3, split=".sign") +
  geom_point(shape = 1,colour = "black") +
  scale_color_viridis(option = "inferno", direction = -1) +
  facet_grid(.~.sign)+
...
tiff(file = 'Figures/Exp_vs_PF_Lung_dot_plots_big.tiff', units="in",width=10, height=15, res=500)
big + plot_annotation(tag_levels = 'A') & 
  theme(plot.tag = element_text(size = 16, vjust = -10))
dev.off()
